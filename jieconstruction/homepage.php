...
<head>
    ...
    <link rel="stylesheet" href="css/construc.css">
...
<body>
    ...
    <header>
      <a href="#home" class="logo">
        <img class="logo" src="img/Company-icon2.webp" alt="logo">
    </a>

    <ul class="navlist">
        <li><a class="active" href="homepaphp"><i class="fas fa-home"></i> HOME</a></li>
  ...
  <form action="services.php">
    ...
    <div class="container" id="home">
      <img class="imageee" src="img/homebgg.png" alt="">
  ...
  <div class="serv" data-aos="fade-up" data-aos-duration="1000">
    <h1>Our Services</h1>
     <div class="container-box">
        <div class="box" onclick="window.location.href='services.html'">
